INSERT INTO gold.sig_match_possession_passing_high_turnover_affair (
    match_id,
    match_date,
    home_team_id,
    home_team_name,
...
-- ============================================================
-- Signal: sig_match_possession_passing_high_turnover_affair
-- Intent: Detect high-turnover matches where both teams trade possession in volatile phases, then emit symmetric side-oriented rows.
-- Trigger: Total match turnovers >= 60 at period='All', where turnovers
...
triggered_matches AS (
    ...
    WHERE (b.failed_passes_home + b.failed_dribbles_home + b.failed_passes_away + b.failed_dribbles_away) >= 60
)
...
SELECT
    ...
    60 AS trigger_threshold_turnovers,
