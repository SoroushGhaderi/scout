INSERT INTO gold.sig_player_possession_passing_keeper_launch_heavy (
    match_id,
    match_date,
    home_team_id,
    home_team_name,
...
-- Signal: sig_player_possession_passing_keeper_launch_heavy
-- Trigger: goalkeeper attempts >= 20 long balls in a finished match.
-- Intent: identify goalkeeper-led launch-heavy distributions and preserve bilateral passing context for tactical interpretation.
...
WHERE m.match_finished = 1
  ...
  AND coalesce(p.long_ball_attempts, 0) >= 20
