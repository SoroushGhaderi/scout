...
SELECT
    ...
    b.match_total_second_half_goals - 4 AS second_half_goals_above_threshold,
    ...
    toFloat32(coalesce(round(
        100.0 * b.home_second_half_goals / nullIf(toFloat64(b.match_total_second_half_goals), 0),
        1
    ), 0.0)) AS triggered_team_second_half_goal_share_pct,
    toFloat32(coalesce(round(
        100.0 * b.away_second_half_goals / nullIf(toFloat64(b.match_total_second_half_goals), 0),
        1
