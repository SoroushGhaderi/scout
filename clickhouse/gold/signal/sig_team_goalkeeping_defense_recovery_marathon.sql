...
SELECT
    ...
    toInt32(match_recovery_pairs.home_team_recoveries - 80) AS triggered_team_recoveries_above_threshold,
...
WHERE m.match_finished = 1
  AND m.match_id > 0
  AND match_recovery_pairs.home_team_recoveries >= 80
...
SELECT
    ...
    toInt32(match_recovery_pairs.away_team_recoveries - 80) AS triggered_team_recoveries_above_threshold,
...
WHERE m.match_finished = 1
  AND m.match_id > 0
  AND match_recovery_pairs.away_team_recoveries >= 80
