INSERT INTO gold.sig_team_shooting_goals_no_shots_allowed (
    match_id,
    match_date,
    home_team_id,
    home_team_name,
...
-- Signal: sig_team_shooting_goals_no_shots_allowed
-- Trigger: Team allows 0 shots on target to opposition in a finished match (`period = 'All'`).
-- Intent: Identify team-level shot suppression where defensive control prevents on-target attempts,
--         while retaining bilateral attacking/possession context for interpretation.
