INSERT INTO gold.sig_player_possession_passing_century_touches (
    match_id,
    match_date,
    home_team_id,
    home_team_name,
...
-- Signal: sig_player_possession_passing_century_touches
-- Trigger: player records >= 100 touches in a single match.
-- Intent: identify high-volume possession hubs reaching century-touch involvement, with bilateral passing and territorial context.
