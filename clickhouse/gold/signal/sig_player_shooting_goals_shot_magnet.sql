INSERT INTO gold.sig_player_shooting_goals_shot_magnet (
    match_id,
    match_date,
    home_team_id,
    home_team_name,
    ...
    opponent_team_id,
    opponent_team_name,
    trigger_threshold_min_player_share_of_team_total_shots_pct,
    ...
    player_shot_share_above_threshold_pct,
...
-- Signal: sig_player_shooting_goals_shot_magnet
-- Trigger: player accounts for > 60% of their team's total shots in a finished match.
-- Intent: isolate extreme player shot-concentration performances where one attacker
-- dominates team finishing volume, with bilateral team and opponent match context.
...
SELECT
    ...
    toFloat32(60.0) AS trigger_threshold_min_player_share_of_team_total_shots_pct,
    ...
    toFloat32(round(
        ...
        1
    )) AS player_shot_share_above_threshold_pct,
...
ORDER BY
    player_share_of_team_total_shots_pct DESC,
