INSERT INTO gold.sig_match_discipline_cards_card_frenzy (
    match_id,
    match_date,
    home_team_id,
    home_team_name,
...
-- Signal: sig_match_discipline_cards_card_frenzy
-- Intent: Detect card-heavy matches where disciplinary sanctions are exceptionally high.
-- Trigger: combined match cards (yellow + red) >= 10 at period='All'.
WITH base_stats AS (
    SELECT
...
SELECT
    ...
    toInt32(10) AS trigger_threshold_min_combined_cards,
    toInt32(b.match_total_cards) AS match_total_cards,
    toInt32(b.match_total_cards - 10) AS match_total_cards_above_threshold,
