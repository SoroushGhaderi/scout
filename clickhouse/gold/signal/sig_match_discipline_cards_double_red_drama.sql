INSERT INTO gold.sig_match_discipline_cards_double_red_drama (
    match_id,
    match_date,
    home_team_id,
    home_team_name,
    ...
    opponent_team_id,
    opponent_team_name,
    trigger_threshold_min_red_cards_per_team,
    home_red_cards,
    away_red_cards,
...
-- Signal: sig_match_discipline_cards_double_red_drama
-- Intent: Detect bilateral dismissal matches where both teams receive at least one red card.
-- Trigger: red_cards_home >= 1 AND red_cards_away >= 1 at period='All'.
WITH base_stats AS (
    SELECT
...
SELECT
    ...
    toInt32(1) AS trigger_threshold_min_red_cards_per_team,
    toInt32(b.red_cards_home) AS home_red_cards,
    toInt32(b.red_cards_away) AS away_red_cards,
