INSERT INTO gold.sig_team_shooting_goals_early_blitz (
    match_id,
    match_date,
    home_team_id,
    home_team_name,
    ...
    opponent_team_id,
    opponent_team_name,
    trigger_threshold_min_goals_first_15,
    trigger_threshold_window_end_minute,
    triggered_team_goals_first_15,
    opponent_goals_first_15,
    goals_first_15_delta,
    triggered_team_first_goal_minute_first_15,
    triggered_team_first_goal_added_time_first_15,
    triggered_team_first_goal_effective_minute_first_15,
    triggered_team_second_goal_minute_first_15,
    triggered_team_second_goal_added_time_first_15,
    triggered_team_second_goal_effective_minute_first_15,
    minutes_between_first_two_goals_first_15,
    triggered_team_goals_first_15_above_threshold,
...
-- Signal: sig_team_shooting_goals_early_blitz
-- Trigger: Team scores at least 2 non-own goals within the first 15 effective minutes.
-- Intent: Detect explosive early attacking starts and preserve bilateral match context for shot quality,
...
early_goal_events AS (
    ...
    WHERE ge.goal_effective_minute BETWEEN 1 AND 15
),
early_goal_counts AS (
    SELECT
        ege.match_id,
        ege.goal_side,
        count() AS goals_first_15
    FROM early_goal_events AS ege
    GROUP BY
        ege.match_id,
        ege.goal_side
),
early_goal_rollup_base AS (
    SELECT
        ege.match_id,
        ege.goal_side AS triggered_side,
        count() AS triggered_team_goals_first_15,
...
SELECT
    ...
    toInt32(2) AS trigger_threshold_min_goals_first_15,
    toInt32(15) AS trigger_threshold_window_end_minute,
    egr.triggered_team_goals_first_15,
    toInt32(coalesce(ogc.goals_first_15, 0)) AS opponent_goals_first_15,
    toInt32(egr.triggered_team_goals_first_15 - coalesce(ogc.goals_first_15, 0)) AS goals_first_15_delta,
    egr.triggered_team_first_goal_minute_first_15,
    egr.triggered_team_first_goal_added_time_first_15,
    egr.triggered_team_first_goal_effective_minute_first_15,
    egr.triggered_team_second_goal_minute_first_15,
    egr.triggered_team_second_goal_added_time_first_15,
    egr.triggered_team_second_goal_effective_minute_first_15,
    egr.minutes_between_first_two_goals_first_15,
    toInt32(egr.triggered_team_goals_first_15 - 2) AS triggered_team_goals_first_15_above_threshold,
...
INNER JOIN silver.period_stat AS ps
   ...
   AND ps.period = 'All'
LEFT JOIN early_goal_counts AS ogc
...
ORDER BY
    egr.triggered_team_goals_first_15 DESC,
    egr.minutes_between_first_two_goals_first_15 ASC,
    m.match_date DESC,
    m.match_id DESC;
