INSERT INTO gold.sig_player_possession_passing_volume_crosser (
    match_id,
    match_date,
    home_team_id,
    home_team_name,
...
-- Signal: sig_player_possession_passing_volume_crosser
-- Trigger: player attempts >= 15 crosses in a single match.
-- Intent: identify high-volume crosser profiles with bilateral team and opponent passing context.
...
WHERE m.match_finished = 1
  ...
  AND coalesce(p.cross_attempts, 0) >= 15
