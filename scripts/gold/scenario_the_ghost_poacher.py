"""Run the scenario_the_ghost_poacher gold query against ClickHouse."""
...
SQL_FILE = project_root / "clickhouse" / "gold" / "scenario_the_ghost_poacher.sql"
TARGET_TABLE = "gold.scenario_the_ghost_poacher"
