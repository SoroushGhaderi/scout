"""Run the signal_team_possession_passing_efficient_directness gold query against ClickHouse."""
...
TARGET_TABLE = "gold.signal_team_possession_passing_efficient_directness"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run team-possession-passing-efficient-directness signal query from gold SQL folder"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("signal_team_possession_passing_efficient_directness insert completed successfully")
