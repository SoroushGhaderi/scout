"""Run the signal_team_possession_passing_possession_without_purpose gold query against ClickHouse."""
...
TARGET_TABLE = "gold.signal_team_possession_passing_possession_without_purpose"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run team-possession-passing-possession-without-purpose signal query from gold SQL folder"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("signal_team_possession_passing_possession_without_purpose insert completed successfully")
