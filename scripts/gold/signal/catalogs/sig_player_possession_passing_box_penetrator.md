...
sql_path: clickhouse/gold/signal/sig_player_possession_passing_box_penetrator.sql
runner_path: scripts/gold/signal/runners/sig_player_possession_passing_box_penetrator.py
primary_trigger: "player records > 10 touches inside the opposition penalty area"
row_identity:
  - match_id
  - triggered_player_id
  - triggered_team_id
