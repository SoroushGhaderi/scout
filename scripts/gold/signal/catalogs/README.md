...
| `sig_player_discipline_cards_persistent_offender` | player | discipline | cards | `match_player` | active | [sig_player_discipline_cards_persistent_offender.md](sig_player_discipline_cards_persistent_offender.md) |
