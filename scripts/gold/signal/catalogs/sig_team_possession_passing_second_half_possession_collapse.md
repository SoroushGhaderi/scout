...
subfamily: passing
grain: match_team
target_table: gold.sig_team_possession_passing_second_half_possession_collapse
sql_path: clickhouse/gold/signal/sig_team_possession_passing_second_half_possession_collapse.sql
runner_path: scripts/gold/signal/runners/sig_team_possession_passing_second_half_possession_collapse.py
primary_trigger: "(second_half_possession - first_half_possession) < -20` for home or away"
row_identity:
  - match_id
  - triggered_side
version: 1
