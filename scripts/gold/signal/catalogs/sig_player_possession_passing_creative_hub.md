...
| `triggered_player_touches_opp_box` | Triggered player touches in opponent box | Football developer: territorial context showing advanced involvement in chance zones |
...
| `triggered_team_touches_opp_box` | Opponent-box touches by triggered player's team | Football developer: territorial pressure context around chance generation |
...
| `player_share_of_team_touches_opp_box_pct` | Triggered player opponent-box touches as % of team opponent-box touches | Football developer: quantifies creator share of high-leverage final-third presence |
