...
subfamily: passing
grain: match_team
target_table: gold.sig_team_possession_passing_failed_penetration
sql_path: clickhouse/gold/signal/sig_team_possession_passing_failed_penetration.sql
runner_path: scripts/gold/signal/runners/sig_team_possession_passing_failed_penetration.py
primary_trigger: "touches_opp_box >= 30 with shots_inside_box < 10 for the triggered side"
row_identity:
  - match_id
  - triggered_side
version: 1
