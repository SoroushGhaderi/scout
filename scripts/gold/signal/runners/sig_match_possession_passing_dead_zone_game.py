"""Run the sig_match_possession_passing_dead_zone_game gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_match_possession_passing_dead_zone_game"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the match-possession-passing-dead-zone-game signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_match_possession_passing_dead_zone_game insert completed")
