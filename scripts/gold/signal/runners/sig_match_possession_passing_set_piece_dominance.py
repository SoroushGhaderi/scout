"""Run the sig_match_possession_passing_set_piece_dominance gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_match_possession_passing_set_piece_dominance"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the match-possession-passing-set-piece-dominance signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_match_possession_passing_set_piece_dominance insert completed")
