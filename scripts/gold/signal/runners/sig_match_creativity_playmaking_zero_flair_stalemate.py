"""Run the sig_match_creativity_playmaking_zero_flair_stalemate gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_match_creativity_playmaking_zero_flair_stalemate"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the match-creativity-playmaking-zero-flair-stalemate signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_match_creativity_playmaking_zero_flair_stalemate insert completed")
