"""Run the sig_match_shooting_goals_end_to_end_drama gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_match_shooting_goals_end_to_end_drama"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the match-shooting-goals-end-to-end-drama signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_match_shooting_goals_end_to_end_drama insert completed")
