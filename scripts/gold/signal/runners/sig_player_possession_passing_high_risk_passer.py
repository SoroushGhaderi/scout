"""Run the sig_player_possession_passing_high_risk_passer gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_player_possession_passing_high_risk_passer"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-possession-passing-high-risk-passer signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_possession_passing_high_risk_passer insert completed")
