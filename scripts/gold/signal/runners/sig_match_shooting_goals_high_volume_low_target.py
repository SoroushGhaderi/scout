"""Run the sig_match_shooting_goals_high_volume_low_target gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_match_shooting_goals_high_volume_low_target"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the match-shooting-goals-high-volume-low-target signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_match_shooting_goals_high_volume_low_target insert completed")
