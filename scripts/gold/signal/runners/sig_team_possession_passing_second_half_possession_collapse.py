"""Run the sig_team_possession_passing_second_half_possession_collapse gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_team_possession_passing_second_half_possession_collapse"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-possession-passing-second-half-possession-collapse signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_possession_passing_second_half_possession_collapse insert completed")
