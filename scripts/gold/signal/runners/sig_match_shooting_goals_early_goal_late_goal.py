"""Run the sig_match_shooting_goals_early_goal_late_goal gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_match_shooting_goals_early_goal_late_goal"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the match-shooting-goals-early-goal-late-goal signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_match_shooting_goals_early_goal_late_goal insert completed")
