"""Run the sig_player_possession_passing_long_ball_specialist gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_player_possession_passing_long_ball_specialist"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-possession-passing-long-ball-specialist signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_possession_passing_long_ball_specialist insert completed")
