"""Run the sig_team_shooting_goals_shot_on_target_monopoly gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_team_shooting_goals_shot_on_target_monopoly"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-shooting-goals-shot-on-target-monopoly signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_shooting_goals_shot_on_target_monopoly insert completed")
