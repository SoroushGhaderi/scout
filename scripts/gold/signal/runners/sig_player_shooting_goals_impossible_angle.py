"""Run the sig_player_shooting_goals_impossible_angle gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_player_shooting_goals_impossible_angle"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-shooting-goals-impossible-angle signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_shooting_goals_impossible_angle insert completed")
