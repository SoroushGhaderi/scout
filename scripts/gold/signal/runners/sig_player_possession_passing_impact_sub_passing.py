"""Run the sig_player_possession_passing_impact_sub_passing gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_player_possession_passing_impact_sub_passing"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-possession-passing-impact-sub-passing signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_possession_passing_impact_sub_passing insert completed")
