"""Run the sig_team_shooting_goals_no_striker_needed gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_team_shooting_goals_no_striker_needed"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-shooting-goals-no-striker-needed signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_shooting_goals_no_striker_needed insert completed")
