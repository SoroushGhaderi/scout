"""Run the sig_match_shooting_goals_rapid_fire_exchange gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_match_shooting_goals_rapid_fire_exchange"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the match-shooting-goals-rapid-fire-exchange signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_match_shooting_goals_rapid_fire_exchange insert completed")
