"""Run the sig_player_shooting_goals_one_man_army gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_player_shooting_goals_one_man_army"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-shooting-goals-one-man-army signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_shooting_goals_one_man_army insert completed")
