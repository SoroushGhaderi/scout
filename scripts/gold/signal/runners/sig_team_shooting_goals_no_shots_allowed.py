"""Run the sig_team_shooting_goals_no_shots_allowed gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_team_shooting_goals_no_shots_allowed"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-shooting-goals-no-shots-allowed signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_shooting_goals_no_shots_allowed insert completed")
