"""Run the sig_player_shooting_goals_clutch_equalizer gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_player_shooting_goals_clutch_equalizer"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-shooting-goals-clutch-equalizer signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_shooting_goals_clutch_equalizer insert completed")
