"""Run the sig_player_possession_passing_deadball_creator gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_player_possession_passing_deadball_creator"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-possession-passing-deadball-creator signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_possession_passing_deadball_creator insert completed")
