"""Run the sig_match_shooting_goals_one_sided_shooting gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_match_shooting_goals_one_sided_shooting"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the match-shooting-goals-one-sided-shooting signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_match_shooting_goals_one_sided_shooting insert completed")
