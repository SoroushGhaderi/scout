"""Run the sig_player_discipline_cards_walking_tightrope gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_player_discipline_cards_walking_tightrope"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-discipline-cards-walking-tightrope signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_discipline_cards_walking_tightrope insert completed")
