"""Run the sig_match_shooting_goals_own_goal_drama gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_match_shooting_goals_own_goal_drama"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the match-shooting-goals-own-goal-drama signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_match_shooting_goals_own_goal_drama insert completed")
