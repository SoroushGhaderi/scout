"""Run the sig_team_discipline_cards_total_implosion gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_team_discipline_cards_total_implosion"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-discipline-cards-total-implosion signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_discipline_cards_total_implosion insert completed")
