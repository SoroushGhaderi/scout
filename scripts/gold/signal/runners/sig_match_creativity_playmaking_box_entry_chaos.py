"""Run the sig_match_creativity_playmaking_box_entry_chaos gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_match_creativity_playmaking_box_entry_chaos"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the match-creativity-playmaking-box-entry-chaos signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_match_creativity_playmaking_box_entry_chaos insert completed")
