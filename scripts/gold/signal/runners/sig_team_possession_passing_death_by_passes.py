"""Run the sig_team_possession_passing_death_by_passes gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_team_possession_passing_death_by_passes"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-possession-passing-death-by-passes signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_possession_passing_death_by_passes insert completed")
