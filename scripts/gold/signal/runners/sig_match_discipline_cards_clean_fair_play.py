"""Run the sig_match_discipline_cards_clean_fair_play gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_match_discipline_cards_clean_fair_play"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the match-discipline-cards-clean-fair-play signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_match_discipline_cards_clean_fair_play insert completed")
