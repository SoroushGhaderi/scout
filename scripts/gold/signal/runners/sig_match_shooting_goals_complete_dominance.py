"""Run the sig_match_shooting_goals_complete_dominance gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_match_shooting_goals_complete_dominance"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the match-shooting-goals-complete-dominance signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_match_shooting_goals_complete_dominance insert completed")
