"""Run the sig_player_discipline_cards_dirty_half_dozen gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_player_discipline_cards_dirty_half_dozen"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-discipline-cards-dirty-half-dozen signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_discipline_cards_dirty_half_dozen insert completed")
