"""Run the sig_match_shooting_goals_penalty_decided_match gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_match_shooting_goals_penalty_decided_match"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the match-shooting-goals-penalty-decided-match signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_match_shooting_goals_penalty_decided_match insert completed")
