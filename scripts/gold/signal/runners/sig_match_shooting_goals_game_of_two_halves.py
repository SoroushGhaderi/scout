"""Run the sig_match_shooting_goals_game_of_two_halves gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_match_shooting_goals_game_of_two_halves"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the match-shooting-goals-game-of-two-halves signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_match_shooting_goals_game_of_two_halves insert completed")
