"""Run the sig_match_shooting_goals_clean_sheet_broken_late gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_match_shooting_goals_clean_sheet_broken_late"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the match-shooting-goals-clean-sheet-broken-late signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_match_shooting_goals_clean_sheet_broken_late insert completed")
