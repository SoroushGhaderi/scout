"""Run the sig_player_goalkeeping_defense_low_block_anchor gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_player_goalkeeping_defense_low_block_anchor"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-goalkeeping-defense-low-block-anchor signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_goalkeeping_defense_low_block_anchor insert completed")
