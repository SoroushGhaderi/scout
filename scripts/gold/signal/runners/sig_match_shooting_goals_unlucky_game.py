"""Run the sig_match_shooting_goals_unlucky_game gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_match_shooting_goals_unlucky_game"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the match-shooting-goals-unlucky-game signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_match_shooting_goals_unlucky_game insert completed")
