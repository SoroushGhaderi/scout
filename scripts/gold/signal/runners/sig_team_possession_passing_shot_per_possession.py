"""Run the sig_team_possession_passing_shot_per_possession gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_team_possession_passing_shot_per_possession"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-possession-passing-shot-per-possession signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_possession_passing_shot_per_possession insert completed")
