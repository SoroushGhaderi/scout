"""Run the sig_match_discipline_cards_one_sided_discipline gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_match_discipline_cards_one_sided_discipline"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the match-discipline-cards-one-sided-discipline signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_match_discipline_cards_one_sided_discipline insert completed")
