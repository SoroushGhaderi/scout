"""Run the sig_team_discipline_cards_zero_card_miracle gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_team_discipline_cards_zero_card_miracle"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-discipline-cards-zero-card-miracle signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_discipline_cards_zero_card_miracle insert completed")
