"""Run the sig_player_creativity_playmaking_line_breaker gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_player_creativity_playmaking_line_breaker"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-creativity-playmaking-line-breaker signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_creativity_playmaking_line_breaker insert completed")
