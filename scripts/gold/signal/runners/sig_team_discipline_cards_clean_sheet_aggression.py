"""Run the sig_team_discipline_cards_clean_sheet_aggression gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_team_discipline_cards_clean_sheet_aggression"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-discipline-cards-clean-sheet-aggression signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_discipline_cards_clean_sheet_aggression insert completed")
