"""Run the sig_team_shooting_goals_dead_ball_specialists gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_team_shooting_goals_dead_ball_specialists"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-shooting-goals-dead-ball-specialists signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_shooting_goals_dead_ball_specialists insert completed")
