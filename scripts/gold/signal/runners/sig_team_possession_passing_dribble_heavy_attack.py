"""Run the sig_team_possession_passing_dribble_heavy_attack gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_team_possession_passing_dribble_heavy_attack"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-possession-passing-dribble-heavy-attack signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_possession_passing_dribble_heavy_attack insert completed")
