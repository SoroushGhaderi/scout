"""Run the sig_player_goalkeeping_defense_interception_marathon gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_player_goalkeeping_defense_interception_marathon"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-goalkeeping-defense-interception-marathon signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_goalkeeping_defense_interception_marathon insert completed")
