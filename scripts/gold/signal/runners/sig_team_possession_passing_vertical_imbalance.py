"""Run the sig_team_possession_passing_vertical_imbalance gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_team_possession_passing_vertical_imbalance"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-possession-passing-vertical-imbalance signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_possession_passing_vertical_imbalance insert completed")
