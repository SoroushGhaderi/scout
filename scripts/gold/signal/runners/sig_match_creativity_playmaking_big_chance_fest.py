"""Run the sig_match_creativity_playmaking_big_chance_fest gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_match_creativity_playmaking_big_chance_fest"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the match-creativity-playmaking-big-chance-fest signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_match_creativity_playmaking_big_chance_fest insert completed")
