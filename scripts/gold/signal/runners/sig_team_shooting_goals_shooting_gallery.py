"""Run the sig_team_shooting_goals_shooting_gallery gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_team_shooting_goals_shooting_gallery"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-shooting-goals-shooting-gallery signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_shooting_goals_shooting_gallery insert completed")
