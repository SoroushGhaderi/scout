"""Run the sig_player_possession_passing_keeper_launch_heavy gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_player_possession_passing_keeper_launch_heavy"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-possession-passing-keeper-launch-heavy signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_possession_passing_keeper_launch_heavy insert completed")
