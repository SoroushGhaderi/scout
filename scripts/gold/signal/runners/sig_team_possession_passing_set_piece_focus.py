"""Run the sig_team_possession_passing_set_piece_focus gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_team_possession_passing_set_piece_focus"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-possession-passing-set-piece-focus signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_possession_passing_set_piece_focus insert completed")
