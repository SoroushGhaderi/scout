"""Run the sig_match_shooting_goals_high_xg_low_score gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_match_shooting_goals_high_xg_low_score"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the match-shooting-goals-high-xg-low-score signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_match_shooting_goals_high_xg_low_score insert completed")
