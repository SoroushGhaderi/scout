"""Run the sig_match_discipline_cards_card_frenzy gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_match_discipline_cards_card_frenzy"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the match-discipline-cards-card-frenzy signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_match_discipline_cards_card_frenzy insert completed")
