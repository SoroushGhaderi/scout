"""Run the sig_match_discipline_cards_heated_derby_stats gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_match_discipline_cards_heated_derby_stats"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the match-discipline-cards-heated-derby-stats signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_match_discipline_cards_heated_derby_stats insert completed")
