"""Run the sig_player_discipline_cards_double_yellow_dismissal gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_player_discipline_cards_double_yellow_dismissal"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-discipline-cards-double-yellow-dismissal signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_discipline_cards_double_yellow_dismissal insert completed")
