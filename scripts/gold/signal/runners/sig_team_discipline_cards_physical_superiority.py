"""Run the sig_team_discipline_cards_physical_superiority gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_team_discipline_cards_physical_superiority"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-discipline-cards-physical-superiority signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_discipline_cards_physical_superiority insert completed")
