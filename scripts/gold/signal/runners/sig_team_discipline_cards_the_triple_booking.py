"""Run the sig_team_discipline_cards_the_triple_booking gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_team_discipline_cards_the_triple_booking"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-discipline-cards-the-triple-booking signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_discipline_cards_the_triple_booking insert completed")
