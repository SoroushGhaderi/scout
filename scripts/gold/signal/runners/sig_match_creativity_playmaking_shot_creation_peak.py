"""Run the sig_match_creativity_playmaking_shot_creation_peak gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_match_creativity_playmaking_shot_creation_peak"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the match-creativity-playmaking-shot-creation-peak signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_match_creativity_playmaking_shot_creation_peak insert completed")
