"""Run the sig_player_possession_passing_dribble_threat gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_player_possession_passing_dribble_threat"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-possession-passing-dribble-threat signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_possession_passing_dribble_threat insert completed")
