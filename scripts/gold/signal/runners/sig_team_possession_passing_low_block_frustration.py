"""Run the sig_team_possession_passing_low_block_frustration gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_team_possession_passing_low_block_frustration"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-possession-passing-low-block-frustration signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_possession_passing_low_block_frustration insert completed")
