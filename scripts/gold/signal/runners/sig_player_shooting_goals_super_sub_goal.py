"""Run the sig_player_shooting_goals_super_sub_goal gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_player_shooting_goals_super_sub_goal"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-shooting-goals-super-sub-goal signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_shooting_goals_super_sub_goal insert completed")
