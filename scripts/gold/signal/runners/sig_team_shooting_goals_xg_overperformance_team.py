"""Run the sig_team_shooting_goals_xg_overperformance_team gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_team_shooting_goals_xg_overperformance_team"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the sig_team_shooting_goals_xg_overperformance_team signal query"
    )
