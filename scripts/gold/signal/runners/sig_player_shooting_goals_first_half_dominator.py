"""Run the sig_player_shooting_goals_first_half_dominator gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_player_shooting_goals_first_half_dominator"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-shooting-goals-first-half-dominator signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_shooting_goals_first_half_dominator insert completed")
