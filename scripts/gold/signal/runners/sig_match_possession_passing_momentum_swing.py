"""Run the sig_match_possession_passing_momentum_swing gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_match_possession_passing_momentum_swing"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-possession-passing-momentum-swing signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_match_possession_passing_momentum_swing insert completed")
