"""Run the sig_match_possession_passing_possession_stalemate gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_match_possession_passing_possession_stalemate"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the match-possession-passing-possession-stalemate signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_match_possession_passing_possession_stalemate insert completed")
