"""Run the sig_team_goalkeeping_defense_wing_lockdown_collective gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_team_goalkeeping_defense_wing_lockdown_collective"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-goalkeeping-defense-wing-lockdown-collective signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_goalkeeping_defense_wing_lockdown_collective insert completed")
