"""Run the sig_team_discipline_cards_card_heavy_defeat gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_team_discipline_cards_card_heavy_defeat"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-discipline-cards-card-heavy-defeat signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_discipline_cards_card_heavy_defeat insert completed")
