"""Run the sig_player_possession_passing_overloaded_possession gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_player_possession_passing_overloaded_possession"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-possession-passing-overloaded-possession signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_possession_passing_overloaded_possession insert completed")
