"""Run the sig_team_shooting_goals_rapid_response_goal gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_team_shooting_goals_rapid_response_goal"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-shooting-goals-rapid-response-goal signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_shooting_goals_rapid_response_goal insert completed")
