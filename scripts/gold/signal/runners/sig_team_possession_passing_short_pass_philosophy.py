"""Run the sig_team_possession_passing_short_pass_philosophy gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_team_possession_passing_short_pass_philosophy"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-possession-passing-short-pass-philosophy signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_possession_passing_short_pass_philosophy insert completed")
