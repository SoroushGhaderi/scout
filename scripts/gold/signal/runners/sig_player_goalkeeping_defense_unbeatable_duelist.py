"""Run the sig_player_goalkeeping_defense_unbeatable_duelist gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_player_goalkeeping_defense_unbeatable_duelist"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-goalkeeping-defense-unbeatable-duelist signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_goalkeeping_defense_unbeatable_duelist insert completed")
