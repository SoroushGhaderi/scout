"""Run the sig_match_shooting_goals_shot_efficiency_parity gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_match_shooting_goals_shot_efficiency_parity"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the match-shooting-goals-shot-efficiency-parity signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_match_shooting_goals_shot_efficiency_parity insert completed")
