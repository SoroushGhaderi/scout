"""Run the sig_match_possession_passing_clinical_match gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_match_possession_passing_clinical_match"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the match-possession-passing-clinical-match signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_match_possession_passing_clinical_match insert completed")
