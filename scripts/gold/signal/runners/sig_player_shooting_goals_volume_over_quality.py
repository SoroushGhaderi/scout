"""Run the sig_player_shooting_goals_volume_over_quality gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_player_shooting_goals_volume_over_quality"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-shooting-goals-volume-over-quality signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_shooting_goals_volume_over_quality insert completed")
