"""Run the sig_team_shooting_goals_blank_range gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_team_shooting_goals_blank_range"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-shooting-goals-blank-range signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_shooting_goals_blank_range insert completed")
