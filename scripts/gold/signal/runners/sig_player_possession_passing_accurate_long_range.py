"""Run the sig_player_possession_passing_accurate_long_range gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_player_possession_passing_accurate_long_range"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-possession-passing-accurate-long-range signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_possession_passing_accurate_long_range insert completed")
