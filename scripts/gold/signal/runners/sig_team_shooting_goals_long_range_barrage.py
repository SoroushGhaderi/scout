"""Run the sig_team_shooting_goals_long_range_barrage gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_team_shooting_goals_long_range_barrage"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the sig_team_shooting_goals_long_range_barrage signal query")
