"""Run the sig_player_possession_passing_target_man_aerials gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_player_possession_passing_target_man_aerials"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-possession-passing-target-man-aerials signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_possession_passing_target_man_aerials insert completed")
