"""Run the sig_team_shooting_goals_late_surge_goals gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_team_shooting_goals_late_surge_goals"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-shooting-goals-late-surge-goals signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_shooting_goals_late_surge_goals insert completed")
