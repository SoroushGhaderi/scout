"""Run the sig_match_shooting_goals_clinical_sub_impact gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_match_shooting_goals_clinical_sub_impact"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the match-shooting-goals-clinical-sub-impact signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_match_shooting_goals_clinical_sub_impact insert completed")
