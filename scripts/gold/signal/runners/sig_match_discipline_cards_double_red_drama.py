"""Run the sig_match_discipline_cards_double_red_drama gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_match_discipline_cards_double_red_drama"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the match-discipline-cards-double-red-drama signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_match_discipline_cards_double_red_drama insert completed")
