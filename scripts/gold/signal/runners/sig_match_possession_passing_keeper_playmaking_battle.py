"""Run the sig_match_possession_passing_keeper_playmaking_battle gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_match_possession_passing_keeper_playmaking_battle"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the match-possession-passing-keeper-playmaking-battle signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_match_possession_passing_keeper_playmaking_battle insert completed")
