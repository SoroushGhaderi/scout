"""Run the sig_match_goalkeeping_defense_save_to_goal_ratio gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_match_goalkeeping_defense_save_to_goal_ratio"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the match-goalkeeping-defense-save-to-goal-ratio signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_match_goalkeeping_defense_save_to_goal_ratio insert completed")
