"""Run the sig_team_discipline_cards_hostile_territory gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_team_discipline_cards_hostile_territory"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-discipline-cards-hostile-territory signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_discipline_cards_hostile_territory insert completed")
