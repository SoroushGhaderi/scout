"""Run the sig_player_shooting_goals_rapid_brace gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_player_shooting_goals_rapid_brace"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the player-shooting-goals-rapid-brace signal query")
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_shooting_goals_rapid_brace insert completed")
