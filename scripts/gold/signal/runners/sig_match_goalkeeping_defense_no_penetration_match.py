"""Run the sig_match_goalkeeping_defense_no_penetration_match gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_match_goalkeeping_defense_no_penetration_match"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the match-goalkeeping-defense-no-penetration-match signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_match_goalkeeping_defense_no_penetration_match insert completed")
