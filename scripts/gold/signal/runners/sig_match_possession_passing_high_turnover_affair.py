"""Run the sig_match_possession_passing_high_turnover_affair gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_match_possession_passing_high_turnover_affair"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the match-possession-passing-high-turnover-affair signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_match_possession_passing_high_turnover_affair insert completed")
