"""Run the sig_team_possession_passing_cross_accuracy_peak gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_team_possession_passing_cross_accuracy_peak"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-possession-passing-cross-accuracy-peak signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_possession_passing_cross_accuracy_peak insert completed")
