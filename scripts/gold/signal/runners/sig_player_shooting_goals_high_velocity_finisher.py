"""Run the sig_player_shooting_goals_high_velocity_finisher gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_player_shooting_goals_high_velocity_finisher"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-shooting-goals-high-velocity-finisher signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_shooting_goals_high_velocity_finisher insert completed")
