"""Run the sig_player_shooting_goals_persistent_threat gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_player_shooting_goals_persistent_threat"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the sig_player_shooting_goals_persistent_threat signal query")
