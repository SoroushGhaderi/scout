"""Run the sig_team_shooting_goals_clinical_finishing_streak gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_team_shooting_goals_clinical_finishing_streak"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the sig_team_shooting_goals_clinical_finishing_streak signal query"
    )
