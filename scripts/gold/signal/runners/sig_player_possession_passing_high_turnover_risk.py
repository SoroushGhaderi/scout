"""Run the sig_player_possession_passing_high_turnover_risk gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_player_possession_passing_high_turnover_risk"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-possession-passing-high-turnover-risk signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_possession_passing_high_turnover_risk insert completed")
