"""Run the sig_team_possession_passing_long_ball_desperation gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_team_possession_passing_long_ball_desperation"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-possession-passing-long-ball-desperation signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_possession_passing_long_ball_desperation insert completed")
