"""Run the sig_match_goalkeeping_defense_physical_duels_peak gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_match_goalkeeping_defense_physical_duels_peak"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the match-goalkeeping-defense-physical-duels-peak signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_match_goalkeeping_defense_physical_duels_peak insert completed")
