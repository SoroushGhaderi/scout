"""Run the sig_team_shooting_goals_defensive_scoring_unit gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_team_shooting_goals_defensive_scoring_unit"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-shooting-goals-defensive-scoring-unit signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_shooting_goals_defensive_scoring_unit insert completed")
