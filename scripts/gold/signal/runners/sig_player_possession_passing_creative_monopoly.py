"""Run the sig_player_possession_passing_creative_monopoly gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_player_possession_passing_creative_monopoly"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-possession-passing-creative-monopoly signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_possession_passing_creative_monopoly insert completed")
