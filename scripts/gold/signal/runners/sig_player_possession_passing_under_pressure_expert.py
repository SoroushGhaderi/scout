"""Run the sig_player_possession_passing_under_pressure_expert gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_player_possession_passing_under_pressure_expert"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-possession-passing-under-pressure-expert signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_possession_passing_under_pressure_expert insert completed")
