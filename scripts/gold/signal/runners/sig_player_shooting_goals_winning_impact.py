"""Run the sig_player_shooting_goals_winning_impact gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_player_shooting_goals_winning_impact"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the sig_player_shooting_goals_winning_impact signal query")
