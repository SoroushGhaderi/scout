"""Run the sig_match_shooting_goals_goalless_siege gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_match_shooting_goals_goalless_siege"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the match-shooting-goals-goalless-siege signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_match_shooting_goals_goalless_siege insert completed")
