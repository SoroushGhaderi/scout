"""Run the sig_player_shooting_goals_the_tap_in_merchant gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_player_shooting_goals_the_tap_in_merchant"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-shooting-goals-the-tap-in-merchant signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_shooting_goals_the_tap_in_merchant insert completed")
