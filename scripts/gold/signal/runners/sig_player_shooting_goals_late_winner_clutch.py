"""Run the sig_player_shooting_goals_late_winner_clutch gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_player_shooting_goals_late_winner_clutch"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-shooting-goals-late-winner-clutch signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_shooting_goals_late_winner_clutch insert completed")
