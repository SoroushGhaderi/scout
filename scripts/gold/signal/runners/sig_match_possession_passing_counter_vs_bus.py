"""Run the sig_match_possession_passing_counter_vs_bus gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_match_possession_passing_counter_vs_bus"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the match-possession-passing-counter-vs-bus signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_match_possession_passing_counter_vs_bus insert completed")
