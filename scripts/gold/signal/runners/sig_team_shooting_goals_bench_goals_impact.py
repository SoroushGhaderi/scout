"""Run the sig_team_shooting_goals_bench_goals_impact gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_team_shooting_goals_bench_goals_impact"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-shooting-goals-bench-goals-impact signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_shooting_goals_bench_goals_impact insert completed")
