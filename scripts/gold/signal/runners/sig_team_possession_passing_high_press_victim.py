"""Run the sig_team_possession_passing_high_press_victim gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_team_possession_passing_high_press_victim"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-possession-passing-high-press-victim signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_possession_passing_high_press_victim insert completed")
