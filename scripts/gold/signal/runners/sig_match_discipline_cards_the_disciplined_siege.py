"""Run the sig_match_discipline_cards_the_disciplined_siege gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_match_discipline_cards_the_disciplined_siege"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the match-discipline-cards-the-disciplined-siege signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_match_discipline_cards_the_disciplined_siege insert completed")
