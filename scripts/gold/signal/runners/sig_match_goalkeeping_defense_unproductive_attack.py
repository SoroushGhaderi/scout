"""Run the sig_match_goalkeeping_defense_unproductive_attack gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_match_goalkeeping_defense_unproductive_attack"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the match-goalkeeping-defense-unproductive-attack signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_match_goalkeeping_defense_unproductive_attack insert completed")
