"""Run the sig_match_possession_passing_early_tactical_lock gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_match_possession_passing_early_tactical_lock"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the match-possession-passing-early-tactical-lock signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_match_possession_passing_early_tactical_lock insert completed")
