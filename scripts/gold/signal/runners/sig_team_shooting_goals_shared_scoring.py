"""Run the sig_team_shooting_goals_shared_scoring gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_team_shooting_goals_shared_scoring"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-shooting-goals-shared-scoring signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_shooting_goals_shared_scoring insert completed")
