"""Run the sig_player_discipline_cards_foul_magnet gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_player_discipline_cards_foul_magnet"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-discipline-cards-foul-magnet signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_discipline_cards_foul_magnet insert completed")
