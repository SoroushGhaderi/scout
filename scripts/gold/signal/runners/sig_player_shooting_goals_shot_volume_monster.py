"""Run the sig_player_shooting_goals_shot_volume_monster gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_player_shooting_goals_shot_volume_monster"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-shooting-goals-shot-volume-monster signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_shooting_goals_shot_volume_monster insert completed")
