"""Run the sig_player_discipline_cards_instant_impact_red gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_player_discipline_cards_instant_impact_red"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-discipline-cards-instant-impact-red signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_discipline_cards_instant_impact_red insert completed")
