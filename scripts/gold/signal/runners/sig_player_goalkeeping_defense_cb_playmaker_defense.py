"""Run the sig_player_goalkeeping_defense_cb_playmaker_defense gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_player_goalkeeping_defense_cb_playmaker_defense"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-goalkeeping-defense-cb-playmaker-defense signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_goalkeeping_defense_cb_playmaker_defense insert completed")
