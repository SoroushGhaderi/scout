"""Run the sig_match_possession_passing_wing_play_extravaganza gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_match_possession_passing_wing_play_extravaganza"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the match-possession-passing-wing-play-extravaganza signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_match_possession_passing_wing_play_extravaganza insert completed")
