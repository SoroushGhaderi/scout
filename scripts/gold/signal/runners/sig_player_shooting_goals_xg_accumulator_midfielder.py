"""Run the sig_player_shooting_goals_xg_accumulator_midfielder gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_player_shooting_goals_xg_accumulator_midfielder"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-shooting-goals-xg-accumulator-midfielder signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_shooting_goals_xg_accumulator_midfielder insert completed")
