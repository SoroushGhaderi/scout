"""Run the sig_team_possession_passing_passing_fatigue_index gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_team_possession_passing_passing_fatigue_index"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-possession-passing-passing-fatigue-index signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_possession_passing_passing_fatigue_index insert completed")
