"""Run the sig_match_shooting_goals_boring_stalemate gold query."""
...
TARGET_TABLE = f"{gold_signals_db()}.sig_match_shooting_goals_boring_stalemate"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the match-shooting-goals-boring-stalemate signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_match_shooting_goals_boring_stalemate insert completed")
