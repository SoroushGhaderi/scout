"""Run the signal_team_possession_passing_total_dominance gold query against ClickHouse."""
...
TARGET_TABLE = "gold.signal_team_possession_passing_total_dominance"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run team-passing-total-dominance signal query from gold SQL folder"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("signal_team_possession_passing_total_dominance insert completed successfully")
