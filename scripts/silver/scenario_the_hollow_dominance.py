"""Run the scenario_the_hollow_dominance silver query against ClickHouse."""
...
SQL_FILE = project_root / "clickhouse" / "silver" / "scenario_the_hollow_dominance.sql"
TARGET_TABLE = "fotmob.silver_scenario_the_hollow_dominance"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the-hollow-dominance scenario query from silver SQL folder"
    )
