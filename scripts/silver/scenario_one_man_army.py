"""Run the scenario_one_man_army silver query against ClickHouse."""
...
SQL_FILE = project_root / "clickhouse" / "silver" / "scenario_one_man_army.sql"
TARGET_TABLE = "fotmob.silver_scenario_one_man_army"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run one-man-army scenario query from silver SQL folder"
    )
