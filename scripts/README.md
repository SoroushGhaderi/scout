...
- `scripts/gold/scenario_the_metronome.py`
...
- `scripts/gold/scenario_the_hollow_dominance.py`
- `scripts/gold/scenario_touchline_terror.py`
- `scripts/gold/scenario_the_line_breaker.py`
- `scripts/gold/scenario_the_basketball_match.py`
- `scripts/gold/scenario_the_lightning_rod.py`
- `scripts/gold/scenario_the_human_shield.py`
- `scripts/gold/scenario_the_golden_touch.py`
- `scripts/gold/scenario_the_black_hole.py`
- `scripts/gold/scenario_high_line_trap.py`
- `scripts/gold/scenario_the_ghost_poacher.py`
