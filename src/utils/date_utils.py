...
DATE_FORMAT_COMPACT = "%Y%m%d"  # YYYYMMDD format (e.g., "20251113")
DATE_FORMAT_DISPLAY = "%Y-%m-%d"  # YYYY-MM-DD format (e.g., "2025-11-13")
DATE_FORMAT_MONTH = "%Y%m"  # YYYYMM format (e.g., "202511")

# Date string slice indices (for YYYYMMDD format)
YEAR_START = 0
YEAR_END = 4
MONTH_START = 4
MONTH_END = 6
...
def format_date_compact_to_display_partial(date_str: str) -> str:
    ...
    # Use first 8 characters for date
