...
def match_event_information(
    match_id: int,
    response_json: json,
    data_class_schema: dataclass = tables_dataclasses.MatchEventInfo,
) -> list[dict]:
    """
...
def match_tournament_information(
    match_id: int,
    response_json: json,
    data_class_schema: dataclass = tables_dataclasses.MatchTournamentInfo,
) -> list[dict]:
    """
    fetch statistics information from sofascore.com/tennis and return them as a dictionary with the following keys:
    - match_id: match identifier
    ...
    single_match_tournament_info = data_class_schema(
        ...
        tournament_category_name=response_json["event"]["tournament"]["category"].get(
            "name"
        ),
        tournament_category_slug=response_json["event"]["tournament"]["category"].get(
            "slug"
        ),
        user_count=response_json["event"]["tournament"]["uniqueTournament"].get(
            "userCount"
        ),
        ground_type=response_json["event"]["tournament"]["uniqueTournament"].get(
            "groundType"
        ),
        tennis_points=response_json["event"]["tournament"]["uniqueTournament"].get(
            "tennisPoints"
        ),
        tournament_unique_id=response_json["event"]["tournament"][
            "uniqueTournament"
        ].get("tournamentId"),
        has_event_player_statistics=response_json["event"]["tournament"][
            "uniqueTournament"
        ].get("hasEventPlayerStatistics"),
        crowd_sourcing_enabled=response_json["event"]["tournament"][
            "uniqueTournament"
        ].get("crowdsourcingEnabled"),
        has_performance_graph_feature=response_json["event"]["tournament"][
            "uniqueTournament"
        ].get("hasPerformanceGraphFeature"),
        display_inverse_home_away_teams=response_json["event"]["tournament"][
            "uniqueTournament"
        ].get("displayInverseHomeAwayTeams"),
...
def match_season_information(
    match_id: int,
    response_json: json,
    data_class_schema: dataclass = tables_dataclasses.MatchSeasonInfo,
) -> list[dict]:
    """
    fetch statistics information from sofascore.com/tennis and return them as a dictionary with the following keys:
    - match_id: match identifier
...
def match_round_information(
    match_id: int,
    response_json: json,
    data_class_schema: dataclass = tables_dataclasses.MatchRoundInfo,
) -> list[dict]:
    """
    fetch statistics information from sofascore.com/tennis and return them as a dictionary with the following keys:
    - match_id: match identifier
...
def match_venue_information(
    match_id: int,
    response_json: json,
    data_class_schema: dataclass = tables_dataclasses.MatchVenueInfo,
) -> list[dict]:
    """
    fetch statistics information from sofascore.com/tennis and return them as a dictionary with the following keys:
    - match_id: match identifier
...
def match_home_team_information(
    match_id: int,
    response_json: json,
    data_class_schema: dataclass = tables_dataclasses.MatchHomeTeamInfo,
) -> list[dict]:
    """
    fetch statistics information from sofascore.com/tennis and return them as a dictionary with the following keys:
    - match_id: match identifier
    ...
    single_match_home_team_info = data_class_schema(
        ...
        birthplace=response_json["event"]["homeTeam"]["playerTeamInfo"].get(
            "birthplace"
        ),
        ...
        turned_pro=response_json["event"]["homeTeam"]["playerTeamInfo"].get(
            "turnedPro"
        ),
        current_prize=response_json["event"]["homeTeam"]["playerTeamInfo"].get(
            "prizeCurrent"
        ),
        total_prize=response_json["event"]["homeTeam"]["playerTeamInfo"].get(
            "prizeTotal"
        ),
...
def match_away_team_information(
    match_id: int,
    response_json: json,
    data_class_schema: dataclass = tables_dataclasses.MatchAwayTeamInfo,
) -> list[dict]:
    """
    fetch statistics information from sofascore.com/tennis and return them as a dictionary with the following keys:
    - match_id: match identifier
    ...
    single_match_away_team_info = data_class_schema(
        ...
        birthplace=response_json["event"]["awayTeam"]["playerTeamInfo"].get(
            "birthplace"
        ),
        ...
        turned_pro=response_json["event"]["awayTeam"]["playerTeamInfo"].get(
            "turnedPro"
        ),
        current_prize=response_json["event"]["awayTeam"]["playerTeamInfo"].get(
            "prizeCurrent"
        ),
        total_prize=response_json["event"]["awayTeam"]["playerTeamInfo"].get(
            "prizeTotal"
        ),
...
def match_home_team_score_information(
    match_id: int,
    response_json: json,
    data_class_schema: dataclass = tables_dataclasses.MatchHomeScoreInfo,
) -> list[dict]:
    """
    fetch statistics information from sofascore.com/tennis and return them as a dictionary with the following keys:
    - match_id: match identifier
...
def match_away_team_score_information(
    match_id: int,
    response_json: json,
    data_class_schema: dataclass = tables_dataclasses.MatchAwayScoreInfo,
) -> list[dict]:
    """
    fetch statistics information from sofascore.com/tennis and return them as a dictionary with the following keys:
    - match_id: match identifier
...
def match_time_information(
    match_id: int,
    response_json: json,
    data_class_schema: dataclass = tables_dataclasses.MatchTimeInfo,
) -> list[dict]:
    """
    fetch statistics information from sofascore.com/tennis and return them as a dictionary with the following keys:
    - match_id: match identifier
    ...
    single_match_time_info = data_class_schema(
        ...
        current_period_start_timestamp=response_json["event"]["time"].get(
...
def main(match_id: int, response_json: json):
    dict_of_functions = {
        ...
        "season": match_season_information,
        "round": match_round_information,
        "venue": match_venue_information,
        "home_team": match_home_team_information,
        "away_team": match_away_team_information,
        "home_team_score": match_home_team_score_information,
        "away_team_score": match_away_team_score_information,
        ...
        try:
            ...
            if len(match_stat) > 0:
                json_to_parquet(
                    ...
                    write_path=file_path["raw_match"]
                    + f"{key}_{match_id}"
                    + ".parquet",
                )
            else:
