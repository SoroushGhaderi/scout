...
import tables_dataclasses as td
from utils import json_to_parquet
from constants import file_path


def match_event_information(
    match_id: int, response_json: json, data_class_schema: dataclass = td.MatchEventInfo
) -> list[dict]:
    """
...
def match_tournament_information(
    match_id: int,
    response_json: json,
    data_class_schema: dataclass = td.MatchTournamentInfo,
) -> list[dict]:
    """
    fetch statistics information from sofascore.com/tennis and return them as a dictionary with the following keys:
    - match_id: match identifier
...
def match_season_information(
    match_id: int,
    response_json: json,
    data_class_schema: dataclass = td.MatchSeasonInfo,
) -> list[dict]:
    """
    fetch statistics information from sofascore.com/tennis and return them as a dictionary with the following keys:
    - match_id: match identifier
...
def match_round_information(
    match_id: int, response_json: json, data_class_schema: dataclass = td.MatchRoundInfo
) -> list[dict]:
    """
    fetch statistics information from sofascore.com/tennis and return them as a dictionary with the following keys:
    - match_id: match identifier
...
def match_venue_information(
    match_id: int, response_json: json, data_class_schema: dataclass = td.MatchVenueInfo
) -> list[dict]:
    """
    fetch statistics information from sofascore.com/tennis and return them as a dictionary with the following keys:
    - match_id: match identifier
...
def match_home_team_information(
    match_id: int,
    response_json: json,
    data_class_schema: dataclass = td.MatchHomeTeamInfo,
) -> list[dict]:
    """
    fetch statistics information from sofascore.com/tennis and return them as a dictionary with the following keys:
    - match_id: match identifier
...
def match_away_team_information(
    match_id: int,
    response_json: json,
    data_class_schema: dataclass = td.MatchAwayTeamInfo,
) -> list[dict]:
    """
    fetch statistics information from sofascore.com/tennis and return them as a dictionary with the following keys:
    - match_id: match identifier
...
def match_home_team_score_information(
    match_id: int,
    response_json: json,
    data_class_schema: dataclass = td.MatchHomeScoreInfo,
) -> list[dict]:
    """
    fetch statistics information from sofascore.com/tennis and return them as a dictionary with the following keys:
    - match_id: match identifier
...
def match_away_team_score_information(
    match_id: int,
    response_json: json,
    data_class_schema: dataclass = td.MatchAwayScoreInfo,
) -> list[dict]:
    """
    fetch statistics information from sofascore.com/tennis and return them as a dictionary with the following keys:
    - match_id: match identifier
...
def match_time_information(
    match_id: int, response_json: json, data_class_schema: dataclass = td.MatchTimeInfo
) -> list[dict]:
    """
    fetch statistics information from sofascore.com/tennis and return them as a dictionary with the following keys:
    - match_id: match identifier
