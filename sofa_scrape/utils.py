...
def build_date_possible_informations(list_of_game_ids: list[int], scrape_date: str) -> pd.DataFrame:
    """
    ...
    possible_scrape_dataframe = (pd.DataFrame(list_of_game_ids, columns=["game_id"])
                                .assign(date=scrape_date,
                                        statistics=0,
                                        match=0,
                                        point_by_point=0,
                                        votes=0,
